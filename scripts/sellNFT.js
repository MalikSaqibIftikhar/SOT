...
const ethNetwork = secret.SOT_PROJECT_RINKEBY;
...
try {
        ...
        const msot = secret.deployedMsotAddress;
    ...
    async function sellNFT() {
        ...
        const tx = {
            ...
            data: nftContract.methods.sellNFT(walletAddress, "0x6357Da64e3Bbdc59fe0e3CAaf7B02b4FBac31d6A", 1, 0, msot , walletAddress).encodeABI(),
